...
public class PostUploader extends JFrame {
    ...
    public PostUploader(String authorId) {
this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        ...
        submitButton.addActionListener(e -> submitPost(backend));

        bottomPanel.add(submitButton);
        add(bottomPanel, BorderLayout.SOUTH);
    }

    private void submitPost(backendContent backend) {
        ...
        newPost.setAuthorId(authorId); // Replace with dynamic author ID if needed
        backend.addPost(newPost, "post_database.json");
