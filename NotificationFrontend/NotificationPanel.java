        ...
        switch (notification.getType()) {
            ...
            case "Chat":
                ...
                viewMessageButton.addActionListener(e -> {
                    // Open chat window
                    UserAccount messageRecieber = GetAccount.getAccount(notification.getRecipientId());
                    if(messageRecieber != null){
                        ChatPage c = new ChatPage(messageRecieber, messageSender, notification.getChatId() );
                    }
            ...
            case "Post Comment":
                        ...
                        System.out.println("iam in the post comment now");
